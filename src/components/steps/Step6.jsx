      ...
      <div className="review-sections">
        <div className="review-section-card">
          <div className="section-header">
            <h3 className="section-main-title">Hospital Information</h3>
          </div>
          ...
          <div className="subsection">
            <div className="subsection-header">
              <h4 className="subsection-title">Facility Details</h4>
              <button
                type="button"
                className="btn-edit"
          ...
          <div className="subsection">
            <div className="subsection-header">
              <h4 className="subsection-title">Leadership Contacts</h4>
              <button
                type="button"
                className="btn-edit"
          ...
          <div className="subsection">
            <div className="subsection-header">
              <h4 className="subsection-title">Site Information</h4>
              <button
                type="button"
                className="btn-edit"
          ...
          <div className="subsection">
            <div className="subsection-header">
              <h4 className="subsection-title">Services & Certifications</h4>
              <button
                type="button"
                className="btn-edit"
            ...
            {expandedSections.servicesCertifications && (
              <div className="subsection-content">
                <div className="info-row">
        ...
        <div className="review-section-card ready-to-submit">
          <h3 className="section-main-title">Ready to Submit?</h3>
